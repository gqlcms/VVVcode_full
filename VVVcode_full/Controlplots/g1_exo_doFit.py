...
class doFit_wj_and_wlvj:
    ...
    def __init__(self, in_channel,in_signal_sample, in_mlvj_signal_region_min=500, in_mlvj_signal_region_max=700, in_mj_min=40, in_mj_max=140, in_mlvj_min=400., in_mlvj_max=1400., fit_model="ErfExp_v1", fit_model_alter="ErfPow_v1", input_workspace=None):
        ...
        rrv_mass_lvj= RooRealVar("rrv_mass_lvj","M_{WWW}",(in_mlvj_min+in_mlvj_max)/2.,in_mlvj_min,in_mlvj_max,"GeV");
...
#        else:
        ...
        self.file_Directory="../data_2017vvv_11.22/";
        ...
        self.file_signal     = (self.channel+"_PKUTree_WWWsig.root");
    ...
    def ControlPlots(self):
        ...
        cut=" ((l_eta>1.2 && W_pt<500) || (l_eta<=1.2)) && (CategoryID==1 || CategoryID==-1 || CategoryID==2 || CategoryID==-2|| CategoryID==4 || CategoryID==-4) && m_lvj> 500 && m_lvj<5000 &&((jet_mass_puppi_corr>40 && jet_mass_puppi_corr<65)||(jet_mass_puppi_corr>90&&jet_mass_puppi_corr<150))&&((jet_mass_puppi_corr_2>40 && jet_mass_puppi_corr_2<150)) && passFilter_HBHE>0 && passFilter_GlobalHalo>0 && passFilter_HBHEIso>0 && passFilter_ECALDeadCell>0 && passFilter_GoodVtx>0 && passFilter_EEBadSc>0   && l_pt> %s && MET_et>%s"%(self.lpt_cut, self.MET_cut)
...
#cut="(CategoryID==3 || CategoryID==-3) && m_lvj> 600 && m_lvj<5000 && jet_mass_puppi_corr>40 && jet_mass_puppi_corr<150 && passFilter_HBHE>0 && passFilter_HBHEIso>0 && passFilter_ECALDeadCell>0 && passFilter_GoodVtx>0 && passFilter_EEBadSc>0 && l_pt>%s && MET_et>%s"%(self.lpt_cut, self.MET_cut)
#self.Make_Controlplots(cut,"TopControl",1);

    ######## ++++++++++++++
    def Make_Controlplots(self,cut,tag, TTBarControl=0):
        self.make_controlplot("m_lvj",cut,tag,28,600,4000,"m_{WWW} (GeV)","Events/(50 GeV)",0, TTBarControl );
        ...
        self.make_controlplot("jet_mass_puppi_corr",cut,tag,23,40,155,"m_{jet1} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_mass_puppi_corr_2",cut,tag,23,40,155,"m_{jet2} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_tau2tau1_puppi",cut,tag,25,0,1,"#tau_{21}","Events/(0.04)",0 , TTBarControl);
        self.make_controlplot("jet_tau2tau1_puppi_2",cut,tag,25,0,1,"#tau_{21_2}","Events/(0.04)",0 , TTBarControl);
        ...
        self.make_controlplot("jetAK8puppi_sd",cut,tag,23,40,155,"m_{jet} (GeV)","Events/(5 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_pt_puppi",cut,tag,30,200, 800,"jetAK8_pt (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("jet_pt_puppi_2",cut,tag,30,200, 800,"jetAK8_pt_2 (GeV)","Events/(20 GeV)",0 , TTBarControl);
        self.make_controlplot("jetAK8puppi_eta",cut,tag,20,-2.5,2.5,"jet_eta","Events(0.25)",0 , TTBarControl);
        self.make_controlplot("jetAK8puppi_eta_2",cut,tag,20,-2.5,2.5,"jet_eta_2","Events(0.25)",0 , TTBarControl);
...
#        self.make_controlplot("TMath.Sqrt(2*l_pt*pfMET*(1.0-TMath.Cos(l_phi-pfMETPhi)))",cut,tag,21,0,420,"mT_{Wlep} (GeV)","Events/(20 GeV)",0 , TTBarControl);
    ...
    def make_controlplot(self,variable,cut,tag,nbin,min,max,xtitle="",ytitle="",logy=0 , TTBarControl=0):
        ...
        if self.channel=="mu": tmp_WJets_scale=0.75
...
#        Extratext.SetNDC(); Extratext.SetTextSize(0.032); Extratext.SetTextFont(52); Extratext.SetTextAlign(11); Extratext.SetLineWidth(2); Extratext.Draw();
        ...
        theLeg.AddEntry(hist_Signal, "M_{wkk}=3000 GeV (#times %s)"%(tmp_signal_scale),"L");
