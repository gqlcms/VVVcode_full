...
void EDBR2PKUTree::Loop(TString channelname, Double_t XS, Double_t totaleventnumber, Int_t IsData) {
	...
	//TFile* pileupFile1 = TFile::Open("rereco_2016full_69p2mb_Summer16.root");  
...
/*
                ...
                if (ptlep1>55. && ptlep1<70.)
                   {if (fabs(etalep1)<0.8){El_Data=0.866183;}
                    else if (fabs(etalep1)<1.44){El_Data=0.856773;}
                    else if (fabs(etalep1)<1.57){El_Data=0.714286;}
                    else if (fabs(etalep1)<2.0){El_Data=0.739193;}
                    else if (fabs(etalep1)<2.5){El_Data=0.698765;}
                   }
                else if (ptlep1>=70. && ptlep1<100.)
                   {if (fabs(etalep1)<0.8){El_Data=0.882139;}
                    else if (fabs(etalep1)<1.44){El_Data=0.893051;}
                    else if (fabs(etalep1)<1.57){El_Data=0.8;}
                    else if (fabs(etalep1)<2.0){El_Data=0.789272;}
                    else if (fabs(etalep1)<2.5){El_Data=0.700637;}
                   }
                else if (ptlep1>=100. && ptlep1<120.)
                   {if (fabs(etalep1)<0.8){El_Data=0.903775;}
                    else if (fabs(etalep1)<1.44){El_Data=0.901726;}
                    else if (fabs(etalep1)<1.57){El_Data=0.818182;}
                    else if (fabs(etalep1)<2.0){El_Data=0.806897;}
                    else if (fabs(etalep1)<2.5){El_Data=0.775862;}
                   }
                else if (ptlep1>=120. && ptlep1<180.)
                   {if (fabs(etalep1)<0.8){El_Data=0.961097;}
                    else if (fabs(etalep1)<1.44){El_Data=0.966073;}
                    else if (fabs(etalep1)<1.57){El_Data=1.0;}
                    else if (fabs(etalep1)<2.0){El_Data=0.972678;}
                    else if (fabs(etalep1)<2.5){El_Data=0.975248;}
                   }
                else if (ptlep1>=180. && ptlep1<250.)
                   {if (fabs(etalep1)<0.8){El_Data=0.959327;}
                    else if (fabs(etalep1)<1.44){El_Data=0.968254;}
                    else if (fabs(etalep1)<1.57){El_Data=1.0;}
                    else if (fabs(etalep1)<2.0){El_Data=0.982906;}
                    else if (fabs(etalep1)<2.5){El_Data=0.985294;}
                   }
                else if (ptlep1>=250.)
                   {if (fabs(etalep1)<0.8){El_Data=0.953846;}
                    else if (fabs(etalep1)<1.44){El_Data=0.955696;}
                    else if (fabs(etalep1)<1.57){El_Data=1.0;}
                    else if (fabs(etalep1)<2.0){El_Data=1.0;}
                    else if (fabs(etalep1)<2.5){El_Data=0.964286;}
                   }

                if (ptlep1>55. && ptlep1<70.)
                   {if (fabs(etalep1)<0.8){El_MC=0.864873;}
                    else if (fabs(etalep1)<1.44){El_MC=0.878969;}
                    else if (fabs(etalep1)<1.57){El_MC=0.821429;}
                    else if (fabs(etalep1)<2.0){El_MC=0.849629;}
                    else if (fabs(etalep1)<2.5){El_MC=0.784289;}
                   }
                else if (ptlep1>=70. && ptlep1<100.)
                   {if (fabs(etalep1)<0.8){El_MC=0.899037;}
                    else if (fabs(etalep1)<1.44){El_MC=0.912407;}
                    else if (fabs(etalep1)<1.57){El_MC=0.787234;}
                    else if (fabs(etalep1)<2.0){El_MC=0.86172;}
                    else if (fabs(etalep1)<2.5){El_MC=0.82563;}
                   }
                else if (ptlep1>=100. && ptlep1<120.)
                   {if (fabs(etalep1)<0.8){El_MC=0.936532;}
                    else if (fabs(etalep1)<1.44){El_MC=0.943288;}
                    else if (fabs(etalep1)<1.57){El_MC=0.857143;}
                    else if (fabs(etalep1)<2.0){El_MC=0.8905547;}
                    else if (fabs(etalep1)<2.5){El_MC=0.9099379;}
                   }
                else if (ptlep1>=120. && ptlep1<180.)
                   {if (fabs(etalep1)<0.8){El_MC=0.909938;}
                    else if (fabs(etalep1)<1.44){El_MC=0.986737;}
                    else if (fabs(etalep1)<1.57){El_MC=0.976744;}
                    else if (fabs(etalep1)<2.0){El_MC=0.988249;}
                    else if (fabs(etalep1)<2.5){El_MC=0.989924;}
                   }
                else if (ptlep1>=180. && ptlep1<250.)
                   {if (fabs(etalep1)<0.8){El_MC=0.985003;}
                    else if (fabs(etalep1)<1.44){El_MC=0.989474;}
                    else if (fabs(etalep1)<1.57){El_MC=0.933333;}
                    else if (fabs(etalep1)<2.0){El_MC=0.983333;}
                    else if (fabs(etalep1)<2.5){El_MC=0.981308;}
                   }
                else if (ptlep1>=250.)
                   {if (fabs(etalep1)<0.8){El_MC=0.98951;}
                    else if (fabs(etalep1)<1.44){El_MC=0.992857;}
                    else if (fabs(etalep1)<1.57){El_MC=1.0;}
                    else if (fabs(etalep1)<2.0){El_MC=1.0;}
                    else if (fabs(etalep1)<2.5){El_MC=1.0;}
                   }
                if (MET_et>80. && MET_et<100.){MET_Data=0.002518;MET_MC=0.001897;}
                else if (MET_et>100. && MET_et<150.){MET_Data=0.037708;MET_MC=0.040461;}
                else if (MET_et>150. && MET_et<200.){MET_Data=0.322908;MET_MC=0.385844;}
                else if (MET_et>200. && MET_et<250.){MET_Data=0.737185;MET_MC=0.818529;}
                else if (MET_et>250. && MET_et<300.){MET_Data=0.92568;MET_MC=0.96208;}
                else if (MET_et>300. && MET_et<500.){MET_Data=0.981169;MET_MC=0.990735;}
                else if (MET_et>500.){MET_Data=0.990735;MET_MC=0.996399;}

                trigger_eff=(El_Data+MET_Data-El_Data*MET_Data)/(El_MC+MET_MC-El_MC*MET_MC);
...
*/
 /*               if (ptlep1>50.)
                   {if (fabs(etalep1)<1.444){IDweight=0.971;}
                    else if (fabs(etalep1)>=1.566){IDweight=0.981;}
                   }
*/
                IDweightISO=1.0;
...
//                std::cout<<IDweight<<"        "<<btagweight_center<<"	"<<trigger_eff<<std::endl;
		...
		tmp_categoryID_channel=-1;// -1 for el; 1 for mu
			...
			if (isAnaHP>0 && (HLT_Ele3>0 || HLT_Ele4>0 || HLT_Ele8>0) && lep==11 && nLooseLep==1){ nID_e = nID_e+1; } else{ isAnaHP=-1; }
			...
			if ((HLT_Ele3>0 || HLT_Ele4>0 || HLT_Ele8>0) && lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200.  && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && jetAK8puppi_tau21>0.45 && jetAK8puppi_tau21<=0.75)// && (( jetAK8puppi_sdcorr >0 &&  jetAK8puppi_sdcorr< 150 )) )
			{ isAnaLP=1.; } 
			else{ isAnaLP=-1.; }
			//NP: 0.75<jetAK8puppi_tau21
			if ((HLT_Ele3>0 || HLT_Ele4>0 || HLT_Ele8>0) && lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200.  && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && jetAK8puppi_tau21>0.75)// && (( jetAK8puppi_sdcorr >0 &&  jetAK8puppi_sdcorr< 150 )) )
			{ isAnaNP=1.; } 
			else{ isAnaNP=-1.; }


			//TTbar control
			if ((HLT_Ele3>0 || HLT_Ele4>0 || HLT_Ele8>0) && lep==11 && nLooseLep==1 && ptlep1>55 && fabs(etalep1)<2.5 && MET_et>80 && ptVlepJEC > 200. && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0  && num_bJet>0)// &&  jetAK8puppi_sdcorr>0 && jetAK8puppi_sdcorr <150)
			{ isTTBarControl=1.; } 
		...
		tmp_categoryID_channel=1;// -1 for el; 1 for mu
			//HP: 0<jetAK8puppi_tau21<=0.5;
			if (isAnaHP>0 && lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.4 && nLooseLep==1 ) { nID_mu = nID_mu+1; } else{ isAnaHP=-1; }
			...
			//LP: 0.5<jetAK8puppi_tau21<=0.75;
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.4 && nLooseLep==1 && ptlep1>55 && MET_et>40 && ptVlepJEC>200 && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && jetAK8puppi_tau21>0.45 && jetAK8puppi_tau21<=0.75)// && (( jetAK8puppi_sdcorr >0&& jetAK8puppi_sdcorr< 150 )))
			{ isAnaLP=1.; } 
			else{ isAnaLP=-1.; }

			//NP: 0.75<jetAK8puppi_tau21;
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.4 && nLooseLep==1 && ptlep1>55 && MET_et>40 && ptVlepJEC>200 && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0 && num_bJet<1 && deltaRlepjet>pi_2 && fabs(delPhijetmet) >2.0 && fabs(delPhijetlep)>2.0 && jetAK8puppi_tau21>0.75)//  && (( jetAK8puppi_sdcorr >0&& jetAK8puppi_sdcorr< 150 )))
			{ isAnaNP=1.; } 
			else{ isAnaNP=-1.; }

			//TTbar control
			if (lep==13 && trackIso/ptlep1<0.1 && fabs(etalep1)<2.4 && nLooseLep==1 && ptlep1>55 && MET_et>40 && ptVlepJEC>200 && jet_pt_puppi>200 && fabs(jetAK8puppi_eta)<2.4 && IDLoose>0 && num_bJet>0)// && jetAK8puppi_sdcorr>0 && jetAK8puppi_sdcorr <150)
			{ isTTBarControl=1.; } 
			else{ isTTBarControl=-1.; }
