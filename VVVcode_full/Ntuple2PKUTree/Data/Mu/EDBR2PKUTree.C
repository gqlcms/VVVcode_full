...
/*
                if (ptlep1>55. && ptlep1<60.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.981588;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.965314;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.997187;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.942321;}
                   }
                else if (ptlep1>=60. && ptlep1<80.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.981326;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.9679;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.999736;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.999736;}
                   }
                else if (ptlep1>=80. && ptlep1<120.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.979574;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.965593;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.997179;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.962426;}
                   }
                else if (ptlep1>=120. && ptlep1<200.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.973041;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.946097;}
                    else if (fabs(etalep1)<2.1){trigger_eff=1.007742;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.992778;}
                   }
                else if (ptlep1>=200. && ptlep1<300.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.974837;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.961505;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.983594;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.791664;}
                   }
                else if (ptlep1>=300. && ptlep1<400.)
                   {if (fabs(etalep1)<0.9){trigger_eff=1.002481;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.918688;}
                    else if (fabs(etalep1)<2.1){trigger_eff=1.060261;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.91138;}
                   }
                else if (ptlep1>=400.)
                   {if (fabs(etalep1)<0.9){trigger_eff=0.993988;}
                    else if (fabs(etalep1)<1.2){trigger_eff=0.932478;}
                    else if (fabs(etalep1)<2.1){trigger_eff=0.949462;}
                    else if (fabs(etalep1)<2.4){trigger_eff=0.851005;}
                   }
*/
/*
                trigger_eff=1.0;
